...
def test_inverse_distance_symmetric_points():
    ...
    V_up = kernels.inverse_distance(P_up, S)
    V_down = kernels.inverse_distance(P_down, S)
...
def test_kernel_xx_symmetric_points():
    ...
    Vxx, _, _, _, _ = kernels.second_derivatives(P, S)
...
def test_kernel_yy_symmetric_points():
    ...
    _, _, _, Vyy, _ = kernels.second_derivatives(P, S)
...
def test_kernel_zz_symmetric_points():
    ...
    Vxx, _, _, Vyy, _ = kernels.second_derivatives(P, S)
    Vzz = -(Vxx+Vyy)
...
def test_second_derivatives_decay():
    ...
    Vxx1, Vxy1, Vxz1, Vyy1, Vyz1 = kernels.second_derivatives(P, S)
    ...
    Vxx2, Vxy2, Vxz2, Vyy2, Vyz2 = kernels.second_derivatives(P, S)
...
def test_inverse_distance_known_points():
    ...
    V = kernels.inverse_distance(P,S)
...
def test_second_derivatives_known_points():
    ...
    Vxx, Vxy, Vxz, Vyy, Vyz = kernels.second_derivatives(P,S)
...
def test_first_derivatives_known_points():
    ...
    Vx, Vy, Vz = kernels.first_derivatives(P,S)
